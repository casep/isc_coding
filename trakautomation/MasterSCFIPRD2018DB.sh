...
export TRAKROOT=/trak/scfiPRD/tc
#
...
# apache
# FMFFIHS
# mv /etc/httpd/conf.d/autoindex.conf /etc/httpd/conf.d/autoindex.conf.nope
./do_apache.sh
./do_apacheTune.sh
...
# <Site Code> <Environment> <Type>[Version]
# <routine buffers in MiB> <global buffers in MiB> <lock table size in B> <gmheap in kiB>
# 1023MB 68812MB 128MB 512MB
# Remember to adjust Routines
# https://confluence.iscinternal.com/pages/viewpage.action?pageId=87829750
./do_Environment_config.sh $SITE $ENV $TYPE$VER 1023 68812 134217728 524288

# printing & preview
./do_CUPS.sh
./do_FOPConf.sh $SITE $ENV $TYPE$VER 3072m 3072m
./do_PMSFonts.sh
