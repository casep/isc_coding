...
export TRAKROOT=/trak/sclaprd/dbm
#
...
# 1023MB 127700MB 128MB 1024MB
# https://www.gbmb.org/megabytes
./do_Environment_config.sh $SITE $ENV $TYPE$VER 1023 127700 134217728 1048576
