...
export TRAKROOT=/trak/sclaprd/prt
#
...
# 512MB 21500MB 128MB 1024MB
# https://www.gbmb.org/megabytes
./do_Environment_config.sh $SITE $ENV $TYPE$VER 512 21500 134217728 1048576

# printing & preview
./do_CUPS.sh
./do_FOPConf.sh $SITE $ENV $TYPE$VER 2048m 2048m
./do_PMSFonts.sh
