...
export TMPDIR=/trak/sctaTST/tc2018/temp
export SITE=scta
export ENV=PRD
export VER=2018
export TYPE=DB
...
export TRAKROOT=/trak/sctaPRD/tc2018
#
...
# 1000MB 32000MB 32MB 256MB
# https://www.gbmb.org/megabytes
./do_Environment_config.sh $SITE $ENV $TYPE$VER 1000 4000 33554432 262144
