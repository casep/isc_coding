...
export TMPDIR=/trak/sctaREP/tc2018/temp
export SITE=scta
export ENV=REP
export VER=2018
export TYPE=DB
...
# 512MB 10200MB 16MB 128MB
# https://www.gbmb.org/megabytes
./do_Environment_config.sh $SITE $ENV $TYPE$VER 512 10200 16777216 131072
