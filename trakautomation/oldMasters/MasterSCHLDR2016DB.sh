...
export TRAKROOT=/trak/schlPRD/tc
#
...
# 1000MB 34005MB 128MB 512MB
./do_Environment_config.sh $SITE $ENV $TYPE$VER 1000 34005 134217728 524288
...
./do_hugePages.sh 19256

# Fonts for barcodes
./do_PMSFonts.sh

# Security patch
./do_Feb2017SV.sh $(instname $SITE $ENV $TYPE$VER)
